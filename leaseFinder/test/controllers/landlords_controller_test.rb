...
class LandlordsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post landlords_url, params: { landlord: { email: @landlord.email, name: @landlord.name, office: @landlord.office, password: @landlord.password, phone: @landlord.phone, website: @landlord.website } }
  #   end
  #
  ...
  #   patch landlord_url(@landlord), params: { landlord: { email: @landlord.email, name: @landlord.name, office: @landlord.office, password: @landlord.password, phone: @landlord.phone, website: @landlord.website } }
